...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to WOS version 1.0.0", 0x00

	wel1 db	'*************************************************', 0x00			

	wel2 db '*********** WELCOME TO WOS ************', 0x00 
	...
	wel7 db ' version 1.0.0 of WOS From Yahampath J.A.W - SE/2019/025', 0x00
	...
	strPrompt		db	"WOS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"W", 0x00	;OS details
